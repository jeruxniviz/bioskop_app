...
class _StartState extends State<Start> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(elevation: 0,backgroundColor: Colors.black,shadowColor: Colors.black,),
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text("--Bioskop punya'e kanesa",style: GoogleFonts.basic(color: Colors.white,fontSize: 16),)
                    ],
                  ),
                ],
              ),Container(child: Image.asset('images/welcome.png'),),
              Column(
                children: [
                  Container(
                      child: InkWell(
